...
import torch.nn.functional as F
from components.basic_conv import *
from components.inceptions import Inception4
...
class DenseInception(nn.Module):
    def __init__(self):
        ...
        self.num_channels = 1
        self.num_classes = 1
        self.data_shape = [117, 512]
        self.num_inception_layers = 1            
        ...
        #self.fc1 = nn.Linear(self.data_shape[1] * self.num_channels * 36 * int(self.data_shape[0] / (7*5*5)), 128)
        self.fc1 = nn.Linear(18432, 128) #18432 = 512*36
...
class DenseCNN(nn.Module):
    def __init__(self):
        ...
        self.dense_inception = DenseInception()
        self.sigmoid = nn.Sigmoid()

    def forward(self, s):
        s = self.linear_up(s.permute(0, 2, 1))
        return self.sigmoid(self.dense_inception(s))
